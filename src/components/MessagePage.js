...
const MessagePage = () => {
  ...
  return (
    ...
    >
      ...
      {/* message */}
      <section className="h-[calc(100vh-128px)] overflow-x-hidden sticky-bottom-0 overflow-y-auto scrollbar relative bg-slate-200 bg-opacity-50">
        {/* all messages show */}
        ...
        {message?.imageUrl && (
          <div className="w-full h-full bg-slate-700 absolute bg-opacity-30 flex justify-center items-center rounded overflow-hidden">
            <div
        ...
        {message?.videoUrl && (
          <div className="w-full h-full bg-slate-700 bg-opacity-30 flex justify-center items-center rounded overflow-hidden">
            <div
              className="w-fit p-2 absolute top-0 absolute right-0 cursor-pointer hover:text-red-600"
